...
const Result = () => {
  ...
  /*function generatePdfAndSendEmail() {
    ...
    header.innerHTML = ` <div style="display:flex; margin:15px; ">
              ...
              <h1 style="font-size:16px; font-weight:bold; font-style:italic;">
                    ...
                    <>
                      ...
                      <div className="py-5">
                        ...
                        <div className="bg-purple-50">
                          <div className="flex flex-col items-center py-10">
                            ...
                            <div
                              className="p-5 grid md:grid-cols-3 grid-cols-1 gap-4 "
                              data-aos="fade-up"
                              data-aos-duration="1500"
                            >
                      ...
                      >
                        <div className="flex flex-col  items-center py-10">
                          ...
                          <div
                            className="p-5 grid md:grid-cols-2 grid-cols-1 gap-4"
                            data-aos="fade-up"
                            data-aos-duration="1500"
                          >
                      ...
                      >
                        ...
                        >
                          ...
                          {bestCareer.primaryCareerMatch
                            ...
                            <div className="5 p-5 bg-[#e920630d]  rounded-md mb-10">
